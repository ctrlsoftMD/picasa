...
function web2py_ajax_fields(target) {
  ...
  var date_format = (typeof w2p_ajax_date_format != 'undefined') ? w2p_ajax_date_format : "%d-%m-%Y";
  var datetime_format = (typeof w2p_ajax_datetime_format != 'undefined') ? w2p_ajax_datetime_format : "%d-%m-%Y %H:%M:%S";
